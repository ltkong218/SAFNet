...
hdr_gt_dir = './img_hdr_gt_siggraph17';
hdr_pred_dir = '../img_hdr_pred_siggraph17';
...
fprintf('SIGGRAPH17 Test Average PSNR_l %.3f  SSIM_l %.4f  PSNR_m %.3f  SSIM_m %.4f  HDR-VDP %.2f\n', mean(psnr_l_all), mean(ssim_l_all), mean(psnr_m_all), mean(ssim_m_all), mean(hdrvdp_all));
